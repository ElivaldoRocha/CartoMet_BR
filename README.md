...
- **⚙ Configuração**: **nível** (10 m ou um dos **13 níveis isobáricos** — 1000…50 hPa, reusando o GRIB de perfil do Skew-T por step), **faixas de velocidade** customizáveis, **limiar de calmaria** e a linha **"vento médio · rumo predominante"**; persistida entre sessões; sobre relevo alto, steps sem o nível pedido são pulados com aviso
